...
; ADC_sgnl_conv.asm
;
; Created: 11/20/2021 10:40:04 PM
; Author : Kyle Han
;
...
;***************************************************************************
;* 
;* "pollADC" - Poll the ADC's result int flag
;*
;* Description: Polls ADC0's INTFLAGS register to check if a result is ready.
;* If it is ready, it will read in the value, and update bcd_entries/led_display accordingly
;* Author: Kyle Han
;* Version: 0.1
...
pollADC:
	...
	//Check the flag. If 1, then continue. If 0, then remove the things from the stack and return.
